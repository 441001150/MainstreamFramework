...
public class ZiliaoHomeAdapter extends RecyclerView.Adapter<ZiliaoHomeAdapter.ViewHolder> {
    ...
    public ZiliaoHomeAdapter(Context mContext, LessonListEntity mDatas) {
    ...
    @Override
    public ZiliaoHomeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(mContext, R.layout.item_ziliao_home, null);
        return new ViewHolder(view, mItemClickListener);
    }

    @Override
    public void onBindViewHolder(ZiliaoHomeAdapter.ViewHolder holder, int position) {
