...
public class ClassCenterActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener, ViewPager.OnPageChangeListener {
    ...
    protected int getLayoutView() {
        return R.layout.class_center_activity;
    }
    ...
    public void initToolBar(TitleBuilder mTitleBuilder) {
        mTitleBuilder.setMiddleTitleText("课堂")
