...
public class DownloadedFragment extends BaseFragment<ICoursePersenter> implements CourseContart.View,View.OnClickListener {
    ...
    protected int getLayoutView() {
        return R.layout.downloaded_fragment_layout;
    }
