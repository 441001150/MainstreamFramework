...
public class ZiliaoHomeAdapter$ViewHolder_ViewBinding<T extends ZiliaoHomeAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public ZiliaoHomeAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
